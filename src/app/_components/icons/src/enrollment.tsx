...
export default function SvgIcon(props: SvgIcon) {
  return (
    <BaseIcon {...props}>
      ...
      <path d="M17 3H19C20.105 3 21 3.895 21 5V19C21 20.105 20.105 21 19 21H5C3.895 21 3 20.105 3 19V5C3 3.895 3.895 3 5 3H7" />
      <path d="M11.99 12V3" />
      <path d="M15.591 6.591L12 3L8.409 6.591" />
    </BaseIcon>
  );
}
