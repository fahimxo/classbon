...
export default function SvgIcon(props: SvgIcon) {
  return (
    <BaseIcon {...props}>
      <path d="M15.493 18.25C14.527 18.25 13.743 19.034 13.75 20C13.75 20.966 14.534 21.75 15.5 21.75C16.466 21.75 17.25 20.966 17.25 20C17.25 19.034 16.466 18.25 15.493 18.25" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
